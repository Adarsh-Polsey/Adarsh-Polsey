...
*Mobile Solution Architect | Flutter Developer | FastAPI Backend Developer | Tech Community Contributor*
...
## 💼 **Development Experience & Key Projects**

### 🔹 **AI/NLP Integrator — Oracode (Nov 2025 - Present)**
📌 **Role:** Serves as the AI/NLP integrator for this open-source, offline-first, multilingual coding platform aimed at children in underserved communities.

### 🔹 **Flutter Developer — Inloops Innovations (May 2025 - Present)**
📌 **Projects:** Developed several web and mobile applications, including a full-featured **E-commerce application** and a **Utility-serving application**, handling end-to-end Flutter development.

### 🔹 **Placify - College Placement Platform (June 2024 - March 2025)**
📌 **Role:** Flutter Developer for the Placement Cell, SJC Devagiri.
📌 **Impact:** Developed the Placify application easing placement applications for **3500+ students**, featuring **automated job alerts** and a real-time notification system.

### 🔹 **SJC Blog – Campus Blogging Platform (Dec 2024 - Jan 2025)**
